...
console.log(`${firstName} est un ${job} de ${age} ans`);

// Variable mutation
// 4. Affectez la valeur "vingt-huit" (c'est pas bien de changer le type) à la variable age et la valeur "conducteur" à la variable job. Ensuite, affichez la phrase précédente dans une boîte de dialogue.
job="Conducteur";
age="vingt-huit";
const titi =alert(`${firstName} est un ${job} de ${age} ans`);
...
const titi =prompt("Quel est son nom de famille ?");
/*je ne sais pas ce que je dois faire de "titi"*/