...
const nameJohn="John";
let yearJohn1= 2019-28;
let yearMark1= 2019-33;
console.log(yearJohn);
console.log(`Mark et née en ${yearMark1}`);

// 3. Affichez l'année à laquelle nous serons dans deux ans, le double de l'année et le dixième de l'année.
let yearNow= 2019+2;
let yearDouble= 2019*2;
let yearDixieme= 2019*0.10;
console.log(yearNow);
console.log(yearDixieme);
console.log(yearDouble);
